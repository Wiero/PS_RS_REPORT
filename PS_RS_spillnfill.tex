...
\title{\textbf{Implementierung eines Spill-and-Fill-f\"ahigen Framestacks f\"ur einen AMIDAR basierten Java-Prozessor}}
\subtitle{Seminararbeit vorgelegt von (Robert Wiesner)}
\subsubtitle{Betreuer: Dipl.-Ing. (Changgong Li)\\
			 Beginn: (Beginndatum) \textbar\ Abgabe: 27.02.2017\\
